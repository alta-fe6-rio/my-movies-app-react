...
const MovieCard = (props) => {
	return (
		<div className='container grow flex flex-col bg-slate-500 dark:bg-slate-300 transition duration-500 max-w-sm mx-auto rounded-md text-white'>
			...
			<button onClick={() => alert('on development')} className='mt-auto bg-red-500 py-3 px-5 text-center flex justify-center items-center space-x-2 rounded-md hover:bg-red-600 font-inter'>
				<FaHeart />
